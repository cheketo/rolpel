          ...
          <h4 class="subTitleB"><i class="fa fa-plus-circle"></i> Complete los campos para agregar un nuevo pa&iacute;s</h4>
            <div class="row form-group inline-form-custom-2">
              <div class="col-xs-12 col-sm-6 inner">
                ...
                <?php echo Core::InsertElement('text','title',utf8_encode($Data['title']),'form-control','placeholder="Ingrese un T&iacute;tulo" validateEmpty="Ingrese un t&iacute;tulo." validateFromFile='.PROCESS.'///El t&iacute;tulo ya existe///action:=validate///actualtitle:='.utf8_encode($Data['title']).'///object:=GeolocationCountry"'); ?>
              </div>
            </div><!-- inline-form -->
            <hr>
            <div class="txC">

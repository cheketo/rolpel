  ...
  <div class="box animated fadeIn">
    <div class="box-header flex-justify-center">
      <div class="innerContainer main_form">
            ...
            <div class="row form-group inline-form-custom">
              <div class="col-xs-12">
                  <div id="agent-wrapper"><?php echo Core::InsertElement('select','agent','','form-control chosenSelect','validateEmpty="Seleccione un Contacto"','','0','Sin Contacto'); ?></div>
                  <?php //echo Core::InsertElement("text","agent",'','Hidden',''); ?>
              </div>
            </div>
              ...
              <div id="ItemWrapper">
                ...
                <div id="item_row_1" item="1" class="row form-group inline-form-custom ItemRow bg-gray" style="margin-bottom:0px!important;padding:10px 0px!important;">
                  ...
                  <div class="col-xs-4 txC">
                    ...
                    <?php echo Core::InsertElement('select','item_1','','ItemField1 form-control chosenSelect itemSelect','validateEmpty="Seleccione un Art&iacute;culo" data-placeholder="Seleccione un Art&iacute;culo" item="1"',Core::Select('product','product_id,code',"status='A'",'code'),' ',''); ?>

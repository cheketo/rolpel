          ...
          <div class="flex-allCenter innerContainer">
            <div class="mw100">
              ...
              <div class="form-group">
                <?php echo Core::InsertElement('text','user',$Data['user'],'form-control','placeholder="Usuario" tabindex="1" validateEmpty="El usuario es obligatorio." validateMinLength="3///El usuario debe contener 3 caracteres como m&iacute;nimo." validateFromFile='.PROCESS.'///El usuario ya existe///actualuser:='.utf8_encode($Data['user']).'///action:=validate///object:=AdminUser"'); ?>
              </div>
              <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-12">
                <div class="form-group">
                  ...
                  <?php echo Core::InsertElement('select','profile',$Data['profile_id'],'form-control chosenSelect','validateEmpty="El perfil es obligatorio." data-placeholder="Seleccione un Perfil" tabindex="7"',Core::Select('admin_profile','profile_id,title',"status='A' AND organization_id=".$_SESSION['organization_id']),' ',""); ?>
                </div>
              </div>
              <!-- Groups -->
              <div class="col-lg-6 col-md-12">

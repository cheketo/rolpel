      ...
      <div class="row main-wrapper profile-section">
        ...
        <div class="col-md-7 profile-user-misc">
          <div class="box-body">
            ...
            <p>
              <?php
                $Menues = Core::Select('admin_menu','*',"status = 'A' AND menu_id IN (SELECT menu_id FROM core_relation_user_menu WHERE user_id = ".$_SESSION['user_id'].")");
            ...
            <div class="profile-bussines-logo">
              <?php $Customer = $CoreUser->GetCustomer(); ?>

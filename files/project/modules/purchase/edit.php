<?php
    ...
    if($Data['provider']=='Y')
    {
      ...
      header('Location: list.php?'.Purchase::GetParams());
    	die();
    }
...
<?php include_once('window.purchase.php'); ?>
  ...
  <div class="box animated fadeIn" style="min-width:99%">
    <div class="box-header flex-justify-center">
      <div class="innerContainer main_form" style="min-width:100%">
            ...
            <h4 class="subTitleB"><i class="fa fa-calendar"></i> Fecha de Orden de Compra</h4>
            <div class="row form-group inline-form-custom">
              <div class="col-xs-12">
          ...
          <hr>
          <div class="row txC">
            <button type="button" class="btn btn-success btnGreen" id="BtnEdit"><i class="fa fa-plus"></i> Editar Orden de Compra</button>

            ...
            <div class="row form-group inline-form-custom">
              <div class="col-xs-12">
                <span class="input-group">
                  ...
                  <?php echo Core::InsertElement('text','name',$Data['name'],'form-control',' placeholder="Nombre de la Empresa" validateEmpty="Ingrese un nombre." validateFromFile='.PROCESS.'///El nombre ya existe///action:=validate///actualname:='.$Data['name'].'///object:=Customer" autofocus'); ?>
                </span>
              </div>
            </div>
            <div class="row form-group inline-form-custom">
              <div class="col-xs-12 col-sm-6">
                <span class="input-group">
                  ...
                  <?php echo Core::InsertElement('select','type',$Data['type_id'],'form-control chosenSelect','validateEmpty="El tipo de cliente es obligatorio." data-placeholder="Seleccione un Tipo de Cliente"',Core::Select('customer_type','type_id,name',"status='A'",'name'),' ',''); ?>
                </span>
              </div>
              <div class="col-xs-12 col-sm-6">
                <span class="input-group">
            ...
            <div class="row form-group inline-form-custom">
              ...
              <div class="col-xs-12 col-sm-6">
                <span class="input-group">
                  ...
                  <?php echo Core::InsertElement('text','gross_income_number',$Data['iibb'],'form-control',' placeholder="N&uacute;mero Ingresos Brutos" validateMinLength="10///El n&uacute;mero debe contener 11 caracteres como m&iacute;nimo." validateOnlyNumbers="Ingrese n&uacute;meros &uacute;nicamente."'); ?>
                </span>
              </div>
            </div>
            </form>

...
?>
  ...
  <?php echo Core::InsertElement("hidden","newimage",$Profile->GetDefaultImg()); ?>
            ...
            <div class="row form-group inline-form-custom-2">
              ...
              <div class="col-xs-12 col-sm-6 inner">
                ...
                <div class="form-group" id="groups-wrapper">
                  <?php echo Core::InsertElement('multiple','groups','','form-control chosenSelect','data-placeholder="Seleccione Grupos"',Core::Select('admin_group','group_id,title',"status<>'I' AND organization_id = ".$_SESSION['organization_id'])); ?>
                </div>
              </div>

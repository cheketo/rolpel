	...
	$("#BtnCreate").on("click",function(e){
		...
		if(validate.validateFields('new_company_form') && validateMaps())
		{
			alertify.confirm(utf8_decode('¿Desea modificar los datos de la empresa?'), function(e){
				if(e)
				{
					var process		= '../../library/processes/proc.common.php?object=ConfigurationCompany';
...
$(function(){
	...
	$("#image").change(function(){
		var process		= '../../library/processes/proc.common.php?action=newimage&object=ConfigurationCompany';
		var haveData	= function(returningData)
		{

...
class ConfigurationCompany extends DataBase
{
	var	$ID;
	var $Data;
	var $ImgGalDir		= '../../../skin/images/configuration/company/';
	var $Table			= "configuration_company";
	var $TableID		= "configuration_id";
	
	const DEFAULTIMG	= "../../../skin/images/configuration/company/default.png";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public function Update()
	{
		...
		$Update		= $this->execQuery('update',$this->Table,"name='".$Name."',corporate_name='".$CorporateName."',postal_code='".$PostalCode."',address='".$Address."',cuit=".$CUIT.",iva='".$IVA."',gross_income_tax='".$GrossIncome."',email='".$Email."',fax='".$Fax."',phone='".$Phone."',website='".$Website."',country_id=".$CountryID.",province_id='".$ProvinceID."',region_id=".$RegionID.",zone_id='".$ZoneID."',lat=".$Lat.",lng=".$Lng.",logo='".$Image."'",$this->TableID."=1");
		//echo $this->lastQuery();
	}
	...
	public function Newimage()
	{
		if(count($_FILES['image'])>0)
		{
			...
			if($ID)
			{
				$New = new ConfigurationCompany($ID);
